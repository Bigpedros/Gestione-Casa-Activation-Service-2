...
import { CONTACT_REQUEST_EXCHANGE_FORMAT, CONTACT_REQUEST_EXCHANGE_FORMAT_VERSION, } from './exchange.types.js';
/**
 * Creates a valid ContactRequestExchangeEnvelope from a contact request.
 */
export function createContactRequestExchangeEnvelope(request, exportedAt) {
    const issues = [];
 ...
 */
export function validateContactRequestExchangeEnvelope(input) {
    const issues = [];
 ...
 */
export function serializeContactRequestExchangeEnvelope(input) {
 ...
 */
export function deserializeContactRequestExchangeEnvelope(json) {
 ...
 */
export function buildContactRequestExchangeFileName(input) {
    const validation = validateContactRequestExchangeEnvelope(input);
    if (!validation.isValid || !validation.value) {
        return {
            isValid: false,
