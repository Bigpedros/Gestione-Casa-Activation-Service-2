...
import { CUSTOMER_SCHEMA_VERSION, } from './types.js';
export class CustomerValidator {
    ...
    static normalize(input) {
        ...
        const kind = input.kind === 'organization' ? 'organization' : 'individual';
    ...
    static validate(input) {
        ...
        const validKinds = ['individual', 'organization'];
        if (!validKinds.includes(raw.kind)) {
