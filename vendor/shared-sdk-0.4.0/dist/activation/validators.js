...
export class ActivationValidator {
    ...
    static validateSignedLicenseDocument(input) {
        ...
        if (!raw.license || typeof raw.license !== 'object') {
            ...
            if (typeof rawLicense.licenseCode !== 'string' ||
