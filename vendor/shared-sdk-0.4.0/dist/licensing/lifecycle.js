...
export function calculateExpirationDate(activatedAt, term) {
    if (term === 'perpetual')
        return null;
...
export function calculateRemainingDays(expiresAt, now = new Date()) {
    if (!expiresAt)
        return null;
...
export function evaluateLicense(snapshot, now = new Date()) {
