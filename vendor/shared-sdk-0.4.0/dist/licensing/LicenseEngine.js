import { LICENSE_PAYLOAD_LENGTH, SAFE_ALPHABET, } from './constants.js';
...
export class LicenseEngine {
    static generateCode(randomSource = systemRandomSource) {
    ...
    static async generateUniqueCode(codeExists, maxRetries = 10, randomSource = systemRandomSource) {
...
//# sourceMappingURL=LicenseEngine.js.map