import type { LICENSE_ENGINE_VERSION, LICENSE_SCHEMA_VERSION } from './constants.js';
export type LicenseEdition = 'standard' | 'professional' | 'enterprise';
export type LicenseTerm = 'beta_60_days' | 'annual' | 'perpetual';
export type LicenseLifecycleStatus = 'generated' | 'assigned' | 'sent' | 'activated' | 'suspended' | 'revoked' | 'expired' | 'invalid';
