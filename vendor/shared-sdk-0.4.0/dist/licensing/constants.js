export const LICENSE_ENGINE_VERSION = '2.1';
export const LICENSE_SCHEMA_VERSION = 1;
export const LICENSE_CODE_GROUPS = 4;
export const LICENSE_CODE_GROUP_LENGTH = 4;
export const LICENSE_CODE_RAW_LENGTH = 16;
export const LICENSE_PAYLOAD_LENGTH = 15;
/**
